          ...
          <div className="wrap top-4">
            ...
            <div className="flex flex-col justify-center mx-auto text-center">
              ...
              >
                ...
                >
                  <button className="flex justify-center items-center w-[100px] h-10 border-2  sm:text-nowrap border-lightText hover:bg-lightText/20 hover:text-lightText dark:border-darkText font-medium rounded-3xl text-sm text-lightText  dark:hover:bg-darkText/20 dark:hover:text-darkBg  hover:font-bold hover:border-0 dark:text-darkText gap-1  hover:shadow-darkBg/30">
                    <FaGithub className="h-5 w-5 " />
                    <span>Github</span>
                  </button>
                </a>
                <Link href="/demo">
                  <button className="w-[100px] h-10 sm:text-nowrap font-medium rounded-3xl text-sm hover:font-bold bg-lightText text-lightBtn hover:text-white dark:text-darkText dark:bg-darkBg dark:hover:bg-lightText dark:hover:text-white hover:shadow-xl hover:transition-all ">
